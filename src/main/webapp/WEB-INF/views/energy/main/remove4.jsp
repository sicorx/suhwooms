...
<c:set var="smElecUsePerSpaceDist"><spring:message code="elecUsePerSpaceDist"/></c:set>
...
function retrieveChartData(){
	...
	$.ajax({
		...
		success:function(data){
			...
			$('#tempAvg').val(data.tempAvg);
			$('#lightAvg').val(data.lightAvg);
	...
	$('#chrtUsedArea').bind('jqplotDataClick',
		function(ev, seriesIndex, pointIndex, data){
			...
			fn_divPop("energyDistList", "팝업", 950, 750, args );
...
<div id="loadingArea">
	...
	<input id="tempAvg" type="hidden" class="content" value="" readonly />
	<input id="lightAvg"  type="hidden" class="content" value="" readonly />				
