		...
		<table>
			<tr>
				...
				<td>
					...
					<button onclick="javascript:func_AllBtn();" class="ml_5" style="width:54px; height:20px !important;">이번달</button>
				</td>
			</tr>
		</table>
		<span class="search">
			...
			<table>
		    	...
		    	<tbody>
	       		<tr>
	         		<th>발생<br />매장수</th>
	         		<td>
	         			<div class="sky_blue_box">3</div>
	         		</td>
	         		<td>
	         			<div class="sky_blue_box">5</div>
	         		</td>
	         		<td>
	         			<div class="blue_box">12</div>
	         		</td>
	         		<td>
	         			<div class="sky_blue_box">8</div>
	         		</td>
	         		<td>
	         			<div class="sky_blue_box">5</div>
	         		</td>
	         		<td>
	         			<div class="pink_box">22</div>
	         		</td>
	         		<td>
	         			<div class="blue_box">15</div>
	         		</td>
	         		<td>
	         			<div class="sky_blue_box">3</div>
	         		</td>
	         		...
	         		<td>
	         			<div class="sky_blue_box">7</div>
	         		</td>
	         		<td>
	         			<div class="sky_blue_box">6</div>
	         		</td>
	         		<td>
	         			<div class="pink_box">22</div>
	         		</td>
