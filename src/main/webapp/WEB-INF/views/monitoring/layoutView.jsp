...
div.ui-dialog-titlebar div.ui-widget-header
{
    ...
    <script type="text/javascript">
        ...
        //모니터링으로 페이지 전환
        function fncGotoMonitoring() {
        	
            fncCallPage("monitoring", "");
            //fncCallPage('/retrieveEqmtMessageList', {subText: "", midText: "", topText:""} );
...
<div class="r_wrapper">
    <div class="blind" id="r_left">
        <div class="r_info">
            <a href="/main" class="r_logo"><img src="/images/img_logo.png" alt="Logo"/></a>
        </div>
    ...
    <div id="r_title" class="r_title">
    	...
    	<div class="r_title_left">
    		<!-- home -->
            <div style="position:relative;width:146px;border-right:1px solid #dddddd;float: left;padding-left:10px;">
            	<a href="#" onclick="javascript:fncGotoMonitoring()">
            		<span><img src="images/img_logo_rems.png" alt="Home" /></span>
            	</a>
            </div>
            <!-- //home -->
    ...
    <div id="r_contents" style="height:100%;"> <!-- class="r_contents" -->
    </div>
</div>
</body>
