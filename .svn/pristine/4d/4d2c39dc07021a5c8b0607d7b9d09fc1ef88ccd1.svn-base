...
public interface AuthMgntMapper {
	...
	public int getAuthCd(String param);
	...
	public int saveRemsAuthMgnt(AuthVo param);
	
	public int delRemsAuthMgnt(HashMap<String, Object> params);
