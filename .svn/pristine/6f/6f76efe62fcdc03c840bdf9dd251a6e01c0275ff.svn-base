...
function fncStoreConfigSetting(){
	...
	$.ajax({
		...
		success:function(data){
			...
			$("#signConfVal1").val(arry3[0]);		// 일출시간
			$("#signConfVal2").val(arry3[1]);		// 일출분
			$("#signConfVal3").val(arry2[0]);		// 일몰시간
			$("#signConfVal4").val(arry2[1]);		// 일몰분
		...
		error:function(result){
			$("#signConfVal1").val("08");		// 일출 시간
			$("#signConfVal2").val("00");		// 일출 분
			$("#signConfVal3").val("17");		// 일몰 시간
			$("#signConfVal4").val("00");		// 일몰 분
			$("#signConfValOld").val("08:00,17:00");
			$("#signAppdtDt").val("");
	...
	<div class="r_inputTbl r_horizonTbl">
					...
					<table>
				        ...
				        <tbody>
							<tr>
					            ...
					            <td rowspan="2" class="tleft"><input type="number" id="peakConfVal" name="confVal" style="width:70px;" required/></td>					            
							</tr>
							<tr>
					...
					<table>
				        ...
				        <tbody>
							...
							<tr>
					            ...
					            <td class="tleft"><input type="number" id="tempConfVal" name="tempConfVal" style="width:70px;" min="18" max="30" maxlength="2" required/></td>					            
							</tr>	
							<tr>
								<th colspan="3">최소운영전력(W)<span class="r_required">*</span></th>
								<td colspan="2" class="tleft"><input type='number' id='tempOper' name='tempOper' style="width:100px;" /></td>
							</tr>						
							<tr>
		...
		<div class="r_pageBtnWrapper mr_0 ml0 border_none">
	     	<span class="pageNormal">    			   				     		
	     		...
	     		<button onclick="javascript:fncCancel()">취소</button>
	     	</span>
	     	<br></br>
		</div>
	</div>
