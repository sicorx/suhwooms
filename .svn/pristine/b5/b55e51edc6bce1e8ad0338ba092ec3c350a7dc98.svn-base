...
function init(){
	...
	$("#gridStoreMgnt").jqGrid({
	    ...
	    postData : {
	      ...
	      colNames:['No', '매장코드', '매장명', '조직', '설치일', '게이트웨이', '테몬', '온도줄센서', '하콘', '매장온도센서', '미터', 'CT', 'EMS BOX', '설치작업'],
	      colModel:[ 	  		
	    	  		{name:'records', 		index:'records', 		width:15, align:'center', 	sortable:true, editable:false, editoptions:{readonly:true, size:10}},
	    	  		{name:'viewStrCd', 		index:'viewStrCd', 		width:30, align:'center',	editable:false},
	                {name:'strNm', 			index:'strNm', 			width:40, align:'left', 	editable:false},
	                {name:'orgNm', 			index:'orgNm', 			width:40, align:'left', 	editable:false},
	                {name:'remsStartDt',	index:'remsStartDt',	width:60, align:'center', 	editable:false},	                  
	                {name:'gwCnt',			index:'gwCnt', 	 		width:50, align:'center',	editable:false},
	                {name:'temonCnt', 		index:'temonCnt', 		width:40, align:'center',	editable:false},
	                {name:'lineSensorCnt', 	index:'lineSensorCnt', 	width:40, align:'center',	editable:false},
	                {name:'haconCnt', 		index:'haconCnt', 		width:40, align:'center',	editable:false},
	                {name:'tSensorCnt', 	index:'tSensorCnt', 	width:40, align:'center',	editable:false},
	                {name:'meterCnt', 		index:'meterCnt', 		width:40, align:'center',	editable:false},
	                {name:'ctCnt', 			index:'ctCnt', 			width:40, align:'center',	editable:false},
	                {name:'emsBox', 		index:'emsBox', 		width:40, align:'center',	editable:false},
	                {name:'remsDt', 		index:'remsDt', 		width:40, align:'center',	editable:false},
	           ],
	     jsonReader : {
	          repeatitems:false
	     },
		...
		gridComplete : function(){
			...
			rsltCount = $("#gridStoreMgnt").getGridParam("reccount");			
...
function fn_excelDownload(){
	...
	$('#excelDownload').attr("action", "/downloadEqmtStoreSemsExcel");
