...
$(document).ready(function(){
	...
	$('input:radio[name="scrAlarmYn"]').eq(1).attr('checked', true);	
	  $("#gridStoreMgnt").jqGrid({
	      url:'retrieveInverterControlList',
	      datatype: "json",
	      mtype: 'POST',
	      colNames:['${smSeq}', '${smOrg}', '${smStrNm}', '장치 번호', '장치 용도', '현재 온도',  '${smStrStat}', '${smFailInfo}', 'strCd', 'hubId', 'highTemp', 'lowTemp', 'inSensor', 'deSensor', 'highPressure', 'lowPressure', 'comp', 'link', 'temp1', 'temp2', 'temp3', 'temp4', 'temp5', 'temp6', 'temp7', 'temp8'],
	      colModel:[
	                ...
	                {name:'portNo',index:'portNo', width:85, align:'center', sortable:true, editable:false},
	                {name:'deviceLoc',index:'deviceLoc', width:85, align:'center', sortable:true, editable:false},
	                {name:'sensTemp',index:'sensTemp', width:85, align:'center', sortable:true, editable:false},
		...
		ondblClickRow : function(rowid, iRow, iCol, e) {
			...
			fn_divPop("eqmtInverterControl", "팝업", 930, 680, args);
...
<form id='popupForm' name='popupForm' method='post'> 
	...
	<input type="hidden" id="popArg2" name="strCd">
	<input type="hidden" id="popArg3" name="hubId">
	<input type="hidden" id="popArg4" name="portNo">
</form>
<div id="loadingArea">
