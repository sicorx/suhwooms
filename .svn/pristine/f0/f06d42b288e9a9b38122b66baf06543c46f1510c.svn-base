	...
	<div class="r_search multiLine">
		...
		<table>
			<tr>
				...
				<th>ID/사용자</th>
				<td>
					<input type='text' id='' name='' value="" style="width:100px; margin-right:10px;" />
					<input id="a" type="radio" /><label for="a">사용</label>
					<input id="b" type="radio" /><label for="b">미사용</label>
				</td>
			</tr>
		</table>
		<span class="search">
		    	...
		    	<tbody>
		       		<tr>
		         		...
		         		<td colspan="3" class="tleft">
							<input type="text" style="width:380px;" disabled="disabled" />
						</td>
					</tr>
					<tr>
		         		<th>ID</th>
					...
					<tr>
		         		<th>동의여부</th>
		         		<td class="tleft">
							<input id="aa" type="radio" /><label for="aa">동의</label>
							<input id="bb" type="radio" /><label for="bb">미동의</label>
						</td>
						<th>사용여부</th>
		         		<td class="tleft">
							<input id="aaa" type="radio" /><label for="aaa">사용(Y)</label>
							<input id="bbb" type="radio" /><label for="bbb">미사용(N)</label>
						</td>
					</tr>
				</tbody>
			</table>
