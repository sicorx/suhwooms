...
public class GridMaintainEngineerMgntVo extends GridVo<GridMaintainEngineerMgntVo> {
	...
	public String getEulaYnNm() {
		return eulaYnNm;
	}
	public void setEulaYnNm(String eulaYnNm) {
		this.eulaYnNm = eulaYnNm;
	}
